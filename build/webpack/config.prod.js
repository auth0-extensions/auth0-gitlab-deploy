...
config.output.filename = `auth0-gitlab-deploy.ui.${project.version}.js`;
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin(`auth0-gitlab-deploy.ui.${project.version}.css`, {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', `auth0-gitlab-deploy.ui.vendors.${project.version}.js`),
