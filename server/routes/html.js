...
export default () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//c5ceffda.ngrok.io/app/auth0-gitlab-deploy.ui.<%= assets.version %>.css"><% } %>
  </head>
  <body class="a0-extension">
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//c5ceffda.ngrok.io/app/auth0-gitlab-deploy.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//c5ceffda.ngrok.io/app/auth0-gitlab-deploy.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
